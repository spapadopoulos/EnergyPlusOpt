function data = idfread(filename, classnames)
% IDFREAD - Read and parse EnergyPlus IDF file.
%   data = idfread(filename) reads all data entries from an IDF
...
%
%   data = idfread(filename, classnames) reads all data entries
...
%
% Examples:
%   data = idfread('SmOffPSZ.idf', 'Timestep')

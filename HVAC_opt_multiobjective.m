function y = HVAC_opt_multiobjective(x)
...
%% Loop through the file and change decision variable values
for n = 1:N
    object = IDF(n);
...
%% Update file and run simulation for new evaluation of the objective function.
...
try 
    ...
    % Baltimore model baseline thermal comfort and energy consumption values, in case simulation crashes
    y(1) = 12.5619;
